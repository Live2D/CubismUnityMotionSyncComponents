...
Cubism Unity MotionSync Components is included in Live2D Cubism Components.

Cubism Unity MotionSync Components は Live2D Cubism Components に含まれます。

Cubism Unity MotionSync Components 包括在 Live2D Cubism Components 中。
...
```
Assets/Live2D/CubismMotionSyncPlugin/Samples/Models/Kei_basic
Assets/Live2D/CubismMotionSyncPlugin/Samples/Models/Kei_vowels
```
